...
"""
    ...
    if audience == "kids":
       tone_instruction = "Tone: Energetic, simple, educational, fun, and engaging. Verify content is safe for legal minors (approx 12 years old). Explain complex terms simply. Break down complicated news into bite-sized, easy-to-understand concepts. Provide context where applicable"
